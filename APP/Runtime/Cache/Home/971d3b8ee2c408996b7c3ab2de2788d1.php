...
<div class="main">
    ...
    <div class="activity_right">
        ...
        <br> 
        <div class="rank">
            <?php if(is_array($activity)): $k = 0; $__LIST__ = $activity;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ac): $mod = ($k % 2 );++$k;?>【<?php echo ($k); ?>】
                <a href="__URL__/content/id/<?php echo ($ac["id"]); ?>" title="<?php echo ($ac["title"]); ?>">
                    <?php echo (utf8substr($ac["title"],0,15)); ?>
                </a>  
